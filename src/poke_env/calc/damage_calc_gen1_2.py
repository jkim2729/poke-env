...
def calculate_damage_gen12(
    ...
    Weather.RAINDANCE and move.type == PokemonType.WATER:
        base_damage = math.floor(base_damage * 1.5)
    elif Weather.SUNNYDAY in battle.weather and move.type ==PokemonType.WATER or \
    Weather.RAINDANCE and move.type == PokemonType.FIRE or move.id == 'solarbeam':
